<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeBehind="600.aspx.cs" Inherits="veri_yapilari._600" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    <h2 style="text-align:center;">
        <asp:Literal ID="litBaslik" runat="server" />
    </h2>
    ...
    <asp:UpdatePanel ID="upSema" runat="server" UpdateMode="Always">
        <ContentTemplate>
